...
exports.deleteEmail = exports.insertEmailGroup = exports.allEmailGroups = exports.allEmails = exports.insertEmail = void 0;
...
function insertEmailGroup(data) {
    if (!data || !data.group)
        return;
    try {
        let dateTimeStr = new Date().toISOString();
...
exports.insertEmailGroup = insertEmailGroup;
